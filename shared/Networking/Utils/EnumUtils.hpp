    ...
    public:
        ...
        static std::string GetEnumName(T enumValue, bool toLower) {
            ...
            try {
                ...
                ERROR("REPORT TO ENDER RunMethodException: {}", e.what());
                e.log_backtrace();
            }
            catch (const std::runtime_error& e) {
                ERROR("REPORT TO ENDER runtime_error: {}", e.what());
            }
            catch (...) {
                ERROR("REPORT TO ENDER: Unknown exception");
            }
            return enumName;
        }
        ...
        static T GetEnumValue(std::string enumName, bool ignoreCase) {
            ...
            try {
                ...
                ERROR("REPORT TO ENDER StackTraceException: {}", e.what());
                e.log_backtrace();
            }
            catch (il2cpp_utils::RunMethodException const& e) {
                ERROR("REPORT TO ENDER RunMethodException: {}", e.what());

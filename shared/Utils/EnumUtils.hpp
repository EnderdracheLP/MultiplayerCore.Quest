...
namespace MultiplayerCore::Utils {
    struct EnumUtils {
        ...
        static std::string GetEnumName(T enumValue, bool toLower) {
            ...
            try {
                static auto* enumClass = classof(T);
                static auto* enumType = enumClass ? ::il2cpp_utils::GetSystemType(enumClass) : nullptr;
                Il2CppObject* boxedValue = il2cpp_functions::value_box(enumClass, &enumValue.value);
